...
// Define props interface for SelectSeparator
...
const SelectScrollUpButton = React.forwardRef<HTMLButtonElement, SelectScrollUpButtonProps>(({ className, ...props }, ref) => (
...
const SelectScrollDownButton = React.forwardRef<HTMLButtonElement, SelectScrollDownButtonProps>(({ className, ...props }, ref) => (
...
const SelectSeparator = React.forwardRef<HTMLHRElement, SelectSeparatorProps>(({ className, ...props }, ref) => (
