...
// Define props for SheetHeader and SheetFooter
interface SheetHeaderFooterProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
}
...
const SheetHeader = React.forwardRef<HTMLDivElement, SheetHeaderFooterProps>(({ className, ...props }, ref) => (
  <div
    ref={ref}
...
const SheetFooter = React.forwardRef<HTMLDivElement, SheetHeaderFooterProps>(({ className, ...props }, ref) => (
  <div
    ref={ref}
